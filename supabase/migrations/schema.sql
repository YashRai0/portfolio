...
VALUES
('Resume Optimizer', 'AI-powered resume analyzer built with Claude API. Upload a resume, paste a JD, and get instant optimization suggestions, ATS score, and tailored improvements.', ARRAY['React', 'Node.js', 'Claude API', 'Stripe', 'Clerk'], '#', 'https://github.com/YashRai0/resume-optimizer', 'in_progress', 1),
